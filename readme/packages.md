...
npm WARN   dev postcss@"^7.0.36" from the root project
npm WARN   79 more (autoprefixer, tailwindcss, css-loader, ...)
npm WARN
...
added 2069 packages, and audited 2070 packages in 1m
```
