...
const OptionTwoRoomsThree = () => {
  ...
  const nextComponent = () => {
    ...
    appDispatch(setBedForOneRoomThree(bedOneRoomThree));
    appDispatch(setBedForTwoRoomThree(bedTwoRoomThree));
...
export default OptionTwoRoomsThree;
